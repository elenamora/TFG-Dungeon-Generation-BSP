...
public class AdaptDungeonGeneration : MonoBehaviour
{
	...
	private EnemySpawnerAdapt spawner;
	...
	void Start()
	{
		...
		roomFloor = new GameObject[gameData.playerType.dungeonWidth, gameData.playerType.dungeonHeight];
		DrawRooms(root);
		DrawHallways(root);
		DrawWalls(root);
		DrawBounds(root);
